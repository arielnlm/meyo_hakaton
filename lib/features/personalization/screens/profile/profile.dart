                ...
                child: Column(
                  children: [
                    Obx(() {
                      ...
                      return controller.imageUploading.value ? loader : TCircularImage(image: image, width: 80, height: 80, isNetworkImage: isNetworkImage);
                    }),
                    TextButton(onPressed: controller.imageUploading.value ? (){} : () => controller.uploadUserProfilePicture(), child: const Text('Change Profile Picture')),
                  ],
                ),
              ),
